...
\subsubsection{Classification of MHD instabilities} 
...
They can be further subdivided based on the wave numbers that describe the relative perturbations $\tilde{\psi}(\Vec{r}) =
