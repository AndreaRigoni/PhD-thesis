...
\begin{figure}
    \centering
    \subfigure[]{\includegraphics[height=4cm]{img/3_ML/MLP.png}}
...
\end{equation}
where here the probability is shaped with the weights matrix $\bm{W}$ taking into account the possible multiple outputs of the perceprton.
