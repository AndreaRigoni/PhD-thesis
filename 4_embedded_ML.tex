...
\begin{figure}
    \centering
    \subfigure[]{\includegraphics[width=4cm]{img/4_EmbeddedML/18.png} \label{}}
    \subfigure[]{\includegraphics[width=4cm]{img/4_EmbeddedML/22.png} \label{}}
    \subfigure[]{\includegraphics[width=4cm]{img/4_EmbeddedML/20a.png} \label{}}
    \subfigure[]{\includegraphics[width=4cm]{img/4_EmbeddedML/24a.png} \label{}}
