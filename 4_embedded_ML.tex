...
\begin{figure}
    \centering
    \subfigure[]{\includegraphics[width=6cm]{img/4_EmbeddedML/18.png}}
    \subfigure[]{\includegraphics[width=6cm]{img/4_EmbeddedML/22.png}}
    \subfigure[]{\includegraphics[width=6cm]{img/4_EmbeddedML/20a.png}}
    \subfigure[]{\includegraphics[width=6cm]{img/4_EmbeddedML/24a.png}}
