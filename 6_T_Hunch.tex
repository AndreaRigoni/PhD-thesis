...
A sketch of such implementation design is reported in~\Figure{\ref{}}
\begin{figure}
    \centering
...
Some example of generated profiles have been shown in~\Figure{\ref{fig:step_12_7_rec}}; where the dashed 
\begin{figure}
    \centering
...
Until now the only data that has been accounted is the temperature profile that even being a useful information it becaome 



\begin{lstlisting}[language=Python, caption=Internal VAE method to create the composed network topology]
