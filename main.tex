...
\title{Tools for heterogeneous diagnostic data integration: application to real-time analysis of fusion relevant plasmas}
...
\newcommand{\bVAE}[1]{$\beta-\mathrm{VAE}_#1$}
...
\bibliography{bib/anacleto,bib/ML,bib/plasma,bib/rfx,bib/spider,bib/thesis,bib/magistrale}
